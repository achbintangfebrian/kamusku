    ...
    return (
        <View style={{flex: 1}}>
          ...
          <View style={{padding: 20, backgroundColor: '#03a9f4', elevation: 1, flexDirection: 'row', alignItems: 'center' }}>
            <Icon name="arrow-left" size={25} color="white"  style={{marginRight: 10}} onPress={() => navigation.goBack()}/>
            <Text style={{textAlign: 'center', color: '#FFFFFF', fontWeight: 'bold', fontSize: 20}}>Detail</Text>
          </View>
          <View style={{backgroundColor: 'grey', paddingBottom: 10, margin: 5, borderRadius: 10}}>
